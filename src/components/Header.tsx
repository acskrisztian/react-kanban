...
const Header: React.FC<HeaderProps> = ({ menuOpened, onButtonClicked }) => {
  ...
  return (
    <header className="bg-background relative py-[8px] px-[16px] lg:py-[16px] lg:px-[24px] lg:pl-[4px] shadow flex items-center justify-between">
      <div className="hidden lg:block">
        <button className="p-[4px] cursor-pointer" onClick={onButtonClicked}>
          {menuOpened ? (
      ...
      <div className="absolute left-1/2 -translatex-1/2">Title</div>
